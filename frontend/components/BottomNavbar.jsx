...
const BottomNavbar = () => {
  return (
    <nav className="lg:hidden bg-skin-backgroud text-skin-base absolute left-0 bottom-0 w-full h-[60px] 
        border-t flex justify-center items-center overflow-hidden">
